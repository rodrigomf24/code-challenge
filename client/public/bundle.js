...
/***/ function(module, exports, __webpack_require__) {
	...
	var _householdForm = __webpack_require__(160);

	var _householdForm2 = _interopRequireDefault(_householdForm);

	var _householdPersonForm = __webpack_require__(161);

	var _householdPersonForm2 = _interopRequireDefault(_householdPersonForm);

	var _householdVehicleForm = __webpack_require__(163);

	var _householdVehicleForm2 = _interopRequireDefault(_householdVehicleForm);

	var _householdSummary = __webpack_require__(165);

	var _householdSummary2 = _interopRequireDefault(_householdSummary);
	...
	exports.default = _react2.default.createClass({
	    ...
	    handlePrevious: function handlePrevious(current, data) {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                "div",
	                { className: "row" },
	                this.state.showHouseholdForm ? _react2.default.createElement(_householdForm2.default, { data: this.state.house, onFormSubmit: this.handleHouseholdFormSubmit }) : null,
	                this.state.showPersonForm ? _react2.default.createElement(_householdPersonForm2.default, { data: this.state.persons, onNextButtonClick: this.handleHouseholdPersonFormSubmit, onPreviousButtonClick: this.handlePrevious }) : null,
	                this.state.showVehicleForm ? _react2.default.createElement(_householdVehicleForm2.default, { data: this.state.vehicles, persons: this.state.persons, onNextButtonClick: this.handleHouseholdVehicleFormSubmit, onPreviousButtonClick: this.handlePrevious }) : null,
	                this.state.showSummary ? _react2.default.createElement(_householdSummary2.default, { data: this.state, onPreviousButtonClick: this.handlePrevious, onFinishButtonClick: this.handleFinish }) : null
	            )
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    getAlertsHtml: function getAlertsHtml() {
	        var alertClass;
	        var alerts = this.state.alerts.map(function (alert) {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { key: alert.id, className: alertClass, role: 'alert' },
	                _react2.default.createElement(
	                    'button',
	    ...
	    handleZipChange: function handleZipChange(value) {
	    ...
	    handleBedroomsNumberChange: function handleBedroomsNumberChange(value) {
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'col-xs-12' },
	                _react2.default.createElement('div', { className: 'alerts', dangerouslySetInnerHTML: this.getAlertsHtml() }),
	                _react2.default.createElement(
	                    'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _personForm = __webpack_require__(162);
	...
	exports.default = _react2.default.createClass({
	    displayName: "householdPersonForm",
	    ...
	    handleAddNewButtonClick: function handleAddNewButtonClick(addPerson) {
	        var person = [{
	        ...
	        if ((typeof addPerson === "undefined" ? "undefined" : _typeof(addPerson)) === 'object' && 'first_name' in addPerson) {
	            this.state.list.pop();
	    ...
	    handleRemoveButtonClick: function handleRemoveButtonClick(index) {
	    ...
	    handleOnChildStateChange: function handleOnChildStateChange(index, data) {
	    ...
	    render: function render() {
	        ...
	        var peopleList = this.state.list.map(function (person, index) {
	            return _react2.default.createElement(_personForm2.default, { key: index, position: index, data: person, onStateChange: _this.handleOnChildStateChange, onRemoveButtonClick: _this.handleRemoveButtonClick, onNewButtonClick: _this.handleAddNewButtonClick });
	        });
	        return _react2.default.createElement(
	            "div",
	            { className: "row" },
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    this.state.list.length === 0 ? _react2.default.createElement(
	                        "button",
	                        { type: "button", className: "btn btn-default btn-block", onClick: this.handleAddNewButtonClick },
	                        "Add new"
	                    ) : null,
	                    _react2.default.createElement(
	                        "div",
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    "button",
	                                    { type: "button", onClick: this.handlePreviousButtonClick, className: "btn btn-info" },
	                                    "Previous"
	                                ),
	                                _react2.default.createElement(
	                                    "button",
	                                    { type: "button", onClick: this.handleNextButtonClick, className: "btn btn-info" },
	                                    "Next"
	                                )
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    fieldsAreEmpty: function fieldsAreEmpty() {
	        var emptyFields = false,
	            count = 0,
	            form = this.state;
	    ...
	    handleRemovePersonButtonClick: function handleRemovePersonButtonClick() {
	    ...
	    handleParentUpdate: function handleParentUpdate() {
	        var _this = this;
	        setTimeout(function () {
	    ...
	    handleFirstNameChange: function handleFirstNameChange(value) {
	        this.setState({ first_name: value });
	        this.handleParentUpdate();
	    },
	    handleLastNameChange: function handleLastNameChange(value) {
	    ...
	    handleAgeChange: function handleAgeChange(value) {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', onClick: this.handleRemovePersonButtonClick, className: 'close', 'aria-label': 'Close' },
	                        _react2.default.createElement(
	                            'span',
	                            { 'aria-hidden': 'true' },
	                            '×'
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', onClick: this.handleAdd, className: 'btn btn-info' },
	                        'Add new'
	                    )
	                )
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vehicleForm = __webpack_require__(164);
	...
	exports.default = _react2.default.createClass({
	    displayName: "householdVehicleForm",
	    ...
	    handleAddNewButtonClick: function handleAddNewButtonClick(addVehicle) {
	        var vehicle = [{
	            make: void 0,
	            model: void 0,
	            year: void 0,
	        ...
	        if ((typeof addVehicle === "undefined" ? "undefined" : _typeof(addVehicle)) === 'object' && 'make' in addVehicle) {
	            this.state.list.pop();
	    ...
	    render: function render() {
	        var _this = this,
	            ...
	            console.log(persons);
	            return _react2.default.createElement(_vehicleForm2.default, { key: index, persons: persons, position: index, data: vehicle, onStateChange: _this.handleOnChildStateChange, onRemoveButtonClick: _this.handleRemoveButtonClick, onNewButtonClick: _this.handleAddNewButtonClick });
	        });
	        return _react2.default.createElement(
	            "div",
	            { className: "row" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    handleMakeChange: function handleMakeChange(value) {
	        this.setState({ make: value });
	        this.handleParentUpdate();
	    },
	    handleModelChange: function handleModelChange(value) {
	    ...
	    handleLicensePlateChange: function handleLicensePlateChange(value) {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', onClick: this.handleRemoveButtonClick, className: 'close', 'aria-label': 'Close' },
	                        _react2.default.createElement(
	                            'span',
	                            { 'aria-hidden': 'true' },
	                            '×'
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createClass({
	    ...
	    handleFinishButtonClick: function handleFinishButtonClick(doSave) {
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    null,
	                                    'Number of Bedrooms: ',
	                                    this.state.house.bedrooms_number
	                                )
	                            )
	                        ),
	                        _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'button',
	                                    { type: 'button', onClick: this.handleFinishButtonClick, className: 'btn btn-success' },
	                                    'Save'
	                                ),
	                                _react2.default.createElement(
	                                    'button',
	                                    { type: 'button', onClick: this.handleCancelButtonClick, className: 'btn btn-danger' },
	                                    'Cancel'
	                                )
	                            )
	                        )
